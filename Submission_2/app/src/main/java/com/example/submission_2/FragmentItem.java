...
public class FragmentItem extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //TextView textViewDesc = view.findViewById(R.id.textViewDesc_Item);
        ImageView imageView = view.findViewById(R.id.imageView_Item);

        imageView.setImageResource(getArguments().getInt("image"));

        TextView textView = view.findViewById(R.id.textViewDesc_Item);
        int id = getArguments().getInt("id");
        textView.setText(MyData.FullDescArray[id]);
